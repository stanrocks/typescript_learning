// Array types
// Using brackets:
let names: string[] = ["John", "Mike"];
let ages: number[] = [12, 42, 36];
// Alternative syntax:
let names2: Array<string> = ["John", "Mike"];
let ages2: Array<number> = [12, 42, 36];

names.push(12); // invalid - don't push numbers in array of strings pls

// ==========================================================
// Custom types of arrays:
// at first define custom type of object for example:
type Point = {
	x: number;
	y: number;
};
...
const coords: Point[] = []; // empty array at first, for example
